...
<div class="cmmrm-images">
	...
	<ul class="cmmrm-images-list">
		<li data-id="0" style="display:none"><a href="about:blank" target="_blank" title="<?php echo esc_attr(Labels::getLocalized('dashboard_image_open')); ?>"><img src="about:blank" alt="Image" /></a>
		<span class="cmmrm-image-delete" title="<?php echo esc_attr(Labels::getLocalized('dashboard_image_remove')); ?>">&times;</span></li>
	</ul>
	<a href="#" class="button cmmrm-images-add-btn"><?php echo Labels::getLocalized('dashboard_image_add'); ?></a>
</div>