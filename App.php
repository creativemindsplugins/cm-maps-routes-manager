...
use com\cminds\mapsroutesmanager\controller\AddSettingsTabsController;
...
class App extends Core {
	...
	static function admin_menu() {
		...
		$page = add_menu_page($name, $name, 'manage_options', static::PREFIX, function($q) { return; }, 'dashicons-location-alt', 1234);
	}
